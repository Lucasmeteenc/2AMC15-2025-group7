...
class MediumDeliveryEnv(gym.Env):
    ...
    def __init__(
        ...
        self.start_positions = [self._sample_free_position() for _ in range(20000)]
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.agent_x, self.agent_y = self.start_positions[
            self.nr_resets % len(self.start_positions)
        ]
