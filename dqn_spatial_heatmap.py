...
def main():
    ...
    parser.add_argument(
        "--model",
        default="best_models/default/dqn.pth",
    ...
    parser.add_argument(
        "--trials", type=int, default=100, help="Number of evaluation episodes"
    )
    parser.add_argument(
        "--bw",
        type=float,
    ...
    parser.add_argument(
        "--out", default="dqn_spatial_heatmap.png", help="Output PNG path"
    )
    parser.add_argument(
